...
function _templateObject3() {
  var data = _taggedTemplateLiteral(["query { ", "(id: \"", "\") { ", " } }"]);
...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_index_index_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    var _components_view_view_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./components/view/view.component */
    "./src/app/components/view/view.component.ts");

    var appRoutes = [{
      path: 'gor/:index',
      component: _components_index_index_component__WEBPACK_IMPORTED_MODULE_11__["IndexComponent"]
    }, {
      path: 'gor/:index/:id',
      component: _components_view_view_component__WEBPACK_IMPORTED_MODULE_13__["ViewComponent"]
    }, {
      path: 'gor/:index/:id/edit',
      component: _components_view_view_component__WEBPACK_IMPORTED_MODULE_13__["ViewComponent"]
    }, {
      path: 'gor/:index/:id/new',
      component: _components_view_view_component__WEBPACK_IMPORTED_MODULE_13__["ViewComponent"]
    }];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_components_app_app_component__WEBPACK_IMPORTED_MODULE_10__["AppComponent"], _components_navigation_navigation_component__WEBPACK_IMPORTED_MODULE_12__["NavigationComponent"], _components_index_index_component__WEBPACK_IMPORTED_MODULE_11__["IndexComponent"], _components_view_view_component__WEBPACK_IMPORTED_MODULE_13__["ViewComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClientModule"], apollo_angular__WEBPACK_IMPORTED_MODULE_7__["ApolloModule"], apollo_angular_link_http__WEBPACK_IMPORTED_MODULE_8__["HttpLinkModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot(appRoutes)],
      entryComponents: [_components_index_index_component__WEBPACK_IMPORTED_MODULE_11__["IndexComponent"], _components_view_view_component__WEBPACK_IMPORTED_MODULE_13__["ViewComponent"]],
      providers: [],
  ...
  function srcAppComponentsIndexIndexComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_crud_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/shared/crud.component */
    ...
    var src_app_services_meta_data_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/services/meta-data.service */
    "./src/app/services/meta-data.service.ts");
    /* harmony import */


    var src_app_services_entity_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/services/entity.service */
    "./src/app/services/entity.service.ts");

    var IndexComponent =
    /*#__PURE__*/
    function (_src_app_shared_crud_) {
      _inherits(IndexComponent, _src_app_shared_crud_);

      /**
       *
       */
      function IndexComponent(route, metaDataService, entityService) {
        var _this;

        _classCallCheck(this, IndexComponent);

        _this = _possibleConstructorReturn(this, _getPrototypeOf(IndexComponent).call(this, route, metaDataService, entityService));
        _this.route = route;
      ...
      _createClass(IndexComponent, [{
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    this.setColumns();
                    list = lodash__WEBPACK_IMPORTED_MODULE_2__["get"](this.metaData, 'list');
        ...
        value: function setColumns() {
          ...
          this.fields = this.fields || lodash__WEBPACK_IMPORTED_MODULE_2__["map"](lodash__WEBPACK_IMPORTED_MODULE_2__["filter"](this.schema.fields, function (field) {
            return lodash__WEBPACK_IMPORTED_MODULE_2__["includes"](['SCALAR', 'ENUM'], lodash__WEBPACK_IMPORTED_MODULE_2__["get"](field, 'type.kind'));
          }), function (field) {
            return field.name;
          });
        }
        ...
        get: function get() {
          return lodash__WEBPACK_IMPORTED_MODULE_2__["concat"](this.fields, ['actions']);
        }
      }]);

      return IndexComponent;
    }(src_app_shared_crud_component__WEBPACK_IMPORTED_MODULE_3__["CrudComponent"]);
  ...
  function srcAppComponentsNavigationNavigationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_meta_data_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/services/meta-data.service */
    "./src/app/services/meta-data.service.ts");
    ...
    function () {
       ...
       *
       */
      function NavigationComponent(metaDataService) {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return this.metaDataService.resolveMetaData();
  ...
  function srcAppComponentsViewViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_crud_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/shared/crud.component */
    "./src/app/shared/crud.component.ts");

    var ViewComponent =
    /*#__PURE__*/
    function (_src_app_shared_crud_2) {
      _inherits(ViewComponent, _src_app_shared_crud_2);

      /**
       *
       */
      function ViewComponent(route, metaDataService, entityService) {
        var _this2;

        _classCallCheck(this, ViewComponent);

        _this2 = _possibleConstructorReturn(this, _getPrototypeOf(ViewComponent).call(this, route, metaDataService, entityService));
        _this2.route = route;
        _this2.metaDataService = metaDataService;
        _this2.entityService = entityService;
        _this2.properties = [];
        _this2.entity = {};
        return _this2;
      }
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    this.properties = lodash__WEBPACK_IMPORTED_MODULE_3__["get"](this.metaData, 'view.properties') || lodash__WEBPACK_IMPORTED_MODULE_3__["map"](lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](this.schema.fields, function (field) {
                      return lodash__WEBPACK_IMPORTED_MODULE_3__["includes"](['SCALAR', 'ENUM'], lodash__WEBPACK_IMPORTED_MODULE_3__["get"](field, 'type.kind'));
                    }), function (field) {
                      return field.name;
                    });
                    this.entityService.getEntityData(this.entityName, this.id, this.properties).subscribe(function (entity) {
                      return _this3.entity = entity;
                    });
      ...
      return ViewComponent;
    }(src_app_shared_crud_component__WEBPACK_IMPORTED_MODULE_6__["CrudComponent"]);
  ...
  function srcAppServicesEntityServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(EntityService, [{
        key: "resolveMetaData",
        value: function resolveMetaData(entity) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 3:
                    return _context4.abrupt("return", new Promise(function (resolve) {
                      _this4.apollo.watchQuery({
                        query: graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(_templateObject(), entity)
                      }).valueChanges.subscribe(function (response) {
                        var loading = lodash__WEBPACK_IMPORTED_MODULE_4__["get"](response, 'data.loading');
                        if (loading) return;
                        var data = lodash__WEBPACK_IMPORTED_MODULE_4__["get"](response, 'data.__type');
                        if (data) _this4.metaData[entity] = data;
                        resolve(data);
                      });
                    }));
        ...
        key: "getIndexData",
        value: function getIndexData(index, fields) {
          var query = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(_templateObject2(), index, lodash__WEBPACK_IMPORTED_MODULE_4__["join"](fields));
          return this.apollo.watchQuery({
            query: query
          }).valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (result) {
        ...
        key: "getEntityData",
        value: function getEntityData(entity, id, fields) {
          var query = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default.a(_templateObject3(), entity, id, lodash__WEBPACK_IMPORTED_MODULE_4__["join"](fields));
          return this.apollo.watchQuery({
            query: query,
            errorPolicy: 'all'
          }).valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(function (result) {
            ...
            return lodash__WEBPACK_IMPORTED_MODULE_4__["get"](result, ['data', entity]);
          }, Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            if (error.graphQLErrors) error.graphQLErrors.forEach(function (e) {
  ...
  function srcAppServicesMetaDataServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
       ...
       *
       */
      function MetaDataService(router, apollo) {
      ...
      _createClass(MetaDataService, [{
        key: "resolveMetaData",
        value: function resolveMetaData() {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
                ...
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    return _context5.abrupt("return", new Promise(function (resolve) {
                      return resolve(_this5.metaData);
                    }));

                  case 2:
                    return _context5.abrupt("return", new Promise(function (resolve) {
                      _this5.apollo.watchQuery({
                        query: graphql_tag__WEBPACK_IMPORTED_MODULE_4___default.a(_templateObject4())
                      }).valueChanges.subscribe(function (response) {
                        var loading = lodash__WEBPACK_IMPORTED_MODULE_5___default.a.get(response, 'data.loading');
                        if (loading) return;
                        _this5.metaData = lodash__WEBPACK_IMPORTED_MODULE_5___default.a.get(response, 'data.metaData');

                        _this5.addRoutes();

                        resolve(_this5.metaData);
                      });
                    }));
        ...
        key: "addRoutes",
        value: function addRoutes() {// const routes = _.flatten( _.map( this.metaData, (item:any) => [
  ...
  /***/
  function srcAppSharedCrudComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
       ...
       *
       */
      function CrudComponent(route, metaDataService, entityService) {
                ...
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      ...
                      return _context6.abrupt("return", console.warn("need 'index' in url"));
            ...
            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  ...
                  case 2:
                    data = _context7.sent;
                    this.metaData = lodash__WEBPACK_IMPORTED_MODULE_1__["find"](data, function (item) {
                      return lodash__WEBPACK_IMPORTED_MODULE_1__["get"](item, 'path') === _this7.index;
                    });
                    ...
                    throw new Error("cannot find metadata for '".concat(this.index, "'"));

                  case 6:
                    name = lodash__WEBPACK_IMPORTED_MODULE_1__["get"](this.metaData, 'name');
                    this.entityName = lodash__WEBPACK_IMPORTED_MODULE_1__["get"](this.metaData, 'entity');
                    _context7.next = 10;
                    return this.entityService.resolveMetaData(name);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/thorek/Projects/ing.d/gor.d/graph-on-rails/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
