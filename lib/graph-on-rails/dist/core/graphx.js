...
var enum_filter_attribute_type_1 = require("../filter-attributes/enum-filter-attribute.type");
//
//
var GraphX = /** @class */ (function () {
     ...
     * @param name
     */
    GraphX.prototype.addEnumFilterAttributeType = function (name) {
        var efat = new enum_filter_attribute_type_1.EnumFilterAttributeType(name);
        efat.init(this);
        efat.createTypes();
    };
    //
