...
var enum_filter_type_builder_1 = require("./filter/enum-filter-type-builder");
/**
 *
 */
var MongoDbResolver = /** @class */ (function (_super) {
     ...
     *
     */
    MongoDbResolver.prototype.getScalarFilterTypes = function () {
        return [];
    };
    /**
     *
     */
    MongoDbResolver.prototype.addEnumFilterAttributeType = function (name) {
        var efat = new enum_filter_type_builder_1.EnumFilterTypeBuilder(name);
        // efat.init( this.g );
        efat.createTypes();
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        collection = this.getCollection(entityType);
                        filter = this.getFilterQuery(entityType, root, args);
     ...
     *
     */
    MongoDbResolver.prototype.getFilterQuery = function (entityType, root, args) {
        var filter = lodash_1.default.get(args, 'filter');
        var filterQuery = {};
